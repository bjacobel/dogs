/**
 * dogs's CloudFormation template supports both apps hosted at the root domain (e.g., https://dogs.com)
 * and apps hosted on a subdomain (what is configured below, https://dogs.bjacobel.com).
...
const config = {
  ...
  ProjectFQDomain: 'dogs.bjacobel.com',
